...
public class TTEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TTEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TTEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TTEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TTEDateTimeConverter dateTimeConverter = new TTEStandardDateTimeConverter();

    public TTEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TTEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TTEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TTEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TTEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TTEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
