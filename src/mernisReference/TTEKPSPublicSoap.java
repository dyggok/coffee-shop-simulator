...
public class TTEKPSPublicSoap
{
    ...
    public TTEKPSPublicSoap(){}

    public TTEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TTEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TTEExtendedSoapSerializationEnvelope envelope= new TTEExtendedSoapSerializationEnvelope(TTEExtendedSoapSerializationEnvelope.VER11);
